...
<!-- Begin Containmer -->
<div id="container" style="width: 850px; background-color: rgb(255, 0, 255); background-image: url(images/background2.jpg); background-size: 850px; background-repeat: no-repeat">
  <!-- Begin Masthead -->
...
<!-- End Container -->
  ...
  <div id = "footer" style = "width: 850px">
    <p class = "auto-style5">Copyrigth &copy; 2019
    <a href = "https://www.edu.mx/">Tecnologias de la Información</a>. Reservados todos los derechos.</p>
  </div>
  <!-- End Footer -->
<!-- End Container -->
</body>
