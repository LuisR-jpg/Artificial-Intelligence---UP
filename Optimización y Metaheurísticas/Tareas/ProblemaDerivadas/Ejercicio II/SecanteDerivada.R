...
fDeriv <- function(x, delta = 0.1){
  (f(x + delta) - f(x))/delta 
}
#Secante(-4, 2, 1e-8, 10)
write.csv(Secante(-4, 2, 1e-8, 10), file = "Git/School/Optimización y Metaheurísticas/ProblemaDerivadas/Ejercicio II/Secante.csv") #CSV
